...
<p align="center">
  ⚡ Автоматизация zapret-профилей с умным переключением<br/><br/>
  <b>FluxRoute Desktop — Windows GUI и оркестратор для Flowseal zapret-discord-youtube</b><br/>
  Автоматически запускает, обновляет и переключает BAT-профили без ручной настройки и перезапусков.
</p>

> FluxRoute Desktop — GUI-оболочка для управления профилями Flowseal/zapret-discord-youtube: запуск, обновление и автоматический выбор рабочего профиля в одном окне.
...
<p align="center">
  ⚡ Smart automation for zapret profile switching<br/><br/>
  <b>FluxRoute Desktop — Windows GUI and orchestrator for Flowseal zapret-discord-youtube</b><br/>
  Automatically launches, updates, and switches BAT profiles based on working configurations — no manual setup or restarts needed.
</p>

> FluxRoute Desktop is a modern GUI wrapper for managing `Flowseal/zapret-discord-youtube` profiles: launch, update, and automatically select working profiles from a single window.
