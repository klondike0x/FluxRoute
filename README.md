...
> 
> **Официальный проект — только этот репозиторий:**  
> [`klondike0x/FluxRoute`](https://github.com/klondike0x/FluxRoute)
> 
> - Все легальные форки **обязаны** сохранять в README заметную атрибуцию оригинала и ссылаться на этот репозиторий.
> - Если вы встретили «FluxRoute» или «FluxRoute AI» на GitHub, GitLab, в Telegram или на файлообменниках **без явного указания авторства** — перед вами **неавторизованная копия, нарушающая GPLv3**.
> - Такие копии могут быть вредоносными, нестабильными или содержать ложные обещания. Не скачивайте их.
> 
> **Доверяйте только официальным релизам с зелёной галочкой `Verified` в этом репозитории.**
...
| Фича                             | Описание                                                                           |
| -------------------------------- | ---------------------------------------------------------------------------------- |
| 📡 **TG WS Proxy**               | Встроенная установка Telegram-прокси с автоматическим переключением на рабочие зеркала PyPI (Tsinghua, Aliyun, USTC) при блокировке `pypi.org`|
